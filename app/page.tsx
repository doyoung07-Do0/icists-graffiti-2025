                ...
                <div className="relative pl-8 border-l-2 border-gray-600 space-y-12 mt-4 lg:mt-8">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-gray-300">
                      ...
                      &ldquo;시드머니 퀴즈&rdquo; 세션을 통해 시드머니를 확보한
                      후, 스타트업의 피칭을 들으면서 여러분은 포트폴리오를
                      제출하게 됩니다. 이를 기반으로 여러분은 원하는 스타트업과
                      매칭됩니다!
                    </p>
                  </div>
                  {/* Step 3 */}
                  ...
                  <div className="relative">
                    ...
                    <p className="text-gray-300">
                      섬머나잇 세션은 &lsquo;팀플 팀의 경계를 넘어 더 많은
                      사람들과 교류하고 친해질 수 있는 친목의 장&rsquo;을
                      제공하는 활동입니다.
                    </p>
                  </div>
                  {/* Step 5 */}
